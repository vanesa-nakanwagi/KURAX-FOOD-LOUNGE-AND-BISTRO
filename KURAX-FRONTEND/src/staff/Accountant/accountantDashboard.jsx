...
import { 
  ...
  PlusCircle, Wallet, Share2 , Receipt, Menu 
} from "lucide-react";
...
----------------------------------`;
  ...
  return (
    <div className="space-y-8 p-4 md:p-8 bg-[#0a0a0a] min-h-screen font-[Outfit] text-slate-200">
      ...
      <div className="flex flex-wrap justify-between items-end gap-4">
        ...
        <div className="flex gap-2 items-center">
          ...
          <button
            ...
            className="md:hidden bg-black/40 border border-white/10 p-3 rounded-xl"
          >
            <Menu size={20} />
          </button>
        </div>
      ...
      {/* MOBILE MENU */}
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-[90] bg-black/90 backdrop-blur-md p-6">
          <div className="space-y-4">
            {[
              ...
              <button
                ...
                className="w-full text-left bg-zinc-900/60 border border-white/5 p-4 rounded-2xl font-black uppercase text-xs"
              >
                {label}
              </button>
            ))}
            <button
              ...
              className="w-full text-center text-zinc-500 text-xs font-black mt-6"
            >
              Close
            </button>
          </div>
        ...
        <>
          ...
          {window.innerWidth < 768 && (
            <button
              ...
              className="mt-4 w-full bg-emerald-600 py-4 rounded-2xl font-black uppercase text-xs"
            >
      ...
      {(activeSection === "PETTY" || window.innerWidth >= 768) && (
        <>
          <button
            ...
            className="w-full bg-yellow-400 text-black py-4 rounded-2xl font-black uppercase text-xs mb-4"
          >
            Log Petty Cash
          </button>
