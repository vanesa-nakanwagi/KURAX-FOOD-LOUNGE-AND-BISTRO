...
export default function Sidebar() {
  ...
  // Helper component for the nav links to avoid repetition
  const NavLinks = () => (
    ...
    <>
      ...
      <div className="lg:hidden fixed top-0 left-0 w-full bg-zinc-900 border-b border-slate-800 p-4 flex items-center justify-between z-[60]">
        ...
        <button 
          ...
          className="p-2 text-white bg-zinc-800 rounded-lg"
        >
        ...
        <div className="mb-5 pb-6 border-b border-slate-800">
          <div className="flex items-center gap-3">
            ...
            <div className="leading-tight">
              ...
              <h1 className="text-xs font-medium text-yellow-500">STAFF PANEL</h1>
            </div>
          </div>
        </div>
