      ...
      <div className="flex flex-col md:flex-row items-center md:justify-between px-4 md:px-8 py-4 gap-4 md:gap-0">
        ...
        <div className="w-full sm:w-3/4 md:w-1/3 flex items-center gap-2">
          ...
          <div className="flex-1 relative">
            ...
            />
            <button
              className="absolute right-1 top-1/2 -translate-y-1/2 w-8 h-8 rounded-full bg-yellow-500 flex items-center justify-center"
            >
          ...
          <button
            ...
            className="relative w-10 h-10 rounded-full bg-yellow-500 flex items-center justify-center"
